...
const ContactUs = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-3 sm:p-4 md:p-6 transition-all duration-300">
      ...
      {/* Modal Container - Made COMPACT for Mobile */}
      <div className="bg-white w-full max-w-[800px] rounded-[1.5rem] md:rounded-[2rem] shadow-2xl relative flex flex-col h-auto max-h-[95vh] md:max-h-[85vh] border border-gray-100/50">
        ...
        <div className="px-4 py-3 md:px-8 md:py-4 flex justify-between items-center z-10 gap-3 border-b border-gray-100/60 shrink-0">
          <h2 className="text-gray-900 text-lg md:text-[28px] font-[600] tracking-tight leading-tight flex items-center gap-1.5 md:gap-2">
            ...
            <svg className="w-5 h-5 md:w-6 md:h-6 text-[#16a34a] -mt-0.5 md:-mt-1" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="px-4 py-4 md:px-8 md:py-6 overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-[#16a34a] [&::-webkit-scrollbar-thumb]:rounded-full pr-1.5 md:pr-4">
          ...
          {/* Profile Card - Ultra Compact for Mobile */}
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-5 p-4 md:p-6 rounded-[1.2rem] md:rounded-[1.5rem] bg-white border border-green-100/80 shadow-[0_4px_20px_rgb(22,163,74,0.04)]">
              ...
              <div className="text-center sm:text-left flex-1">
                ...
                <p className="text-gray-500 text-[11px] md:text-[13px] font-[600] leading-snug mb-3 max-w-lg mx-auto sm:mx-0">
                  I specialize in building scalable web applications with a focus on clean code. Passionate about using technology to drive environmental impact.
                </p>
                
                {/* Buttons - Wrapped and smaller */}
                <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                  <a href="https://github.com/manas-2007" target="_blank" rel="noreferrer" className="flex items-center gap-1.5 bg-[#24292e] hover:bg-black text-white text-[11px] md:text-[12px] font-[600] px-3.5 md:px-5 py-2 md:py-2.5 rounded-lg md:rounded-xl transition-all duration-300 shadow-sm whitespace-nowrap">
                    <svg className="w-3.5 h-3.5 md:w-4 md:h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.31 3.435 9.795 8.205 11.385.6.105.825-.255.825-.57 0-.285-.015-1.23-.015-2.235-3.015.555-3.795-.735-4.035-1.41-.135-.345-.72-1.41-1.23-1.695-.42-.225-1.02-.78-.015-.795.945-.015 1.62.87 1.845 1.23 1.08 1.815 2.805 1.305 3.495.99.105-.78.42-1.305.765-1.605-2.67-.3-5.46-1.335-5.46-5.925 0-1.305.465-2.385 1.23-3.225-.12-.3-.54-1.53.12-3.18 0 0 1.005-.315 3.3 1.23.96-.27 1.98-.405 3-.405s2.04.135 3 .405c2.295-1.56 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.765.84 1.23 1.905 1.23 3.225 0 4.605-2.805 5.625-5.475 5.925.435.375.81 1.095.81 2.22 0 1.605-.015 2.895-.015 3.3 0 .315.225.69.825.57C20.565 21.795 24 17.31 24 12c0-6.63-5.37-12-12-12z"/></svg>
                    GitHub
                  </a>
                  <a href="http://www.linkedin.com/in/manas-kumar-patidar-73954a374" target="_blank" rel="noreferrer" className="flex items-center gap-1.5 bg-[#0077b5] hover:bg-[#006396] text-white text-[11px] md:text-[12px] font-[600] px-3.5 md:px-5 py-2 md:py-2.5 rounded-lg md:rounded-xl transition-all duration-300 shadow-sm whitespace-nowrap">
          ...
          <div className="mb-4 md:mb-6 px-1">
            ...
            <p className="text-gray-800 text-[13px] md:text-[16px] leading-snug md:leading-relaxed font-[600] mb-2">
              Building a sustainable future shouldn't be complicated. That's why <span className="text-green-700 font-[600]">ReCircle</span> exists.
            </p>
            ...
            <p className="text-gray-500 text-[11px] md:text-[14px] leading-relaxed hidden sm:block font-[600]">
              We serve as a digital bridge connecting responsible households with verified waste collectors. By making the recycling process transparent and rewarding, we integrate sustainability into everyday life.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 pt-3 md:pt-5 border-t border-gray-100">
            <div className="text-center md:text-left bg-gray-50/50 md:bg-transparent rounded-lg p-2 md:p-0">
              <div className="text-lg md:text-2xl font-[600] text-gray-900 mb-0.5 tracking-tight">100%</div>
              <div className="text-gray-500 text-[9px] md:text-[11px] font-[600] uppercase tracking-wide">Digital Tracking</div>
            </div>
            <div className="text-center md:text-left bg-gray-50/50 md:bg-transparent rounded-lg p-2 md:p-0">
              <div className="text-lg md:text-2xl font-[600] text-gray-900 mb-0.5 tracking-tight">15+</div>
              <div className="text-gray-500 text-[9px] md:text-[11px] font-[600] uppercase tracking-wide">Categories</div>
            </div>
            <div className="text-center md:text-left bg-gray-50/50 md:bg-transparent rounded-lg p-2 md:p-0">
              <div className="text-lg md:text-2xl font-[600] text-gray-900 mb-0.5 tracking-tight">KYC</div>
              <div className="text-gray-500 text-[9px] md:text-[11px] font-[600] uppercase tracking-wide">Verified</div>
            </div>
            <div className="text-center md:text-left bg-green-50/30 md:bg-transparent rounded-lg p-2 md:p-0">
              <div className="text-lg md:text-2xl font-[600] text-[#16a34a] mb-0.5 tracking-tight">Eco</div>
              <div className="text-gray-500 text-[9px] md:text-[11px] font-[600] uppercase tracking-wide">Rewards</div>
            </div>
          </div>

        </div>
        
        {/* ACTION FOOTER: I Understood Button */}
