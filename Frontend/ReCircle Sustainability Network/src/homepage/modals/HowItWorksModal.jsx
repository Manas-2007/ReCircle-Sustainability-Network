  ...
  const modalSteps = [
    {
      ...
      icon: (
        <svg
          className="w-5 h-5 md:w-7 md:h-7 text-[#16a34a]"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth="1.5"
      ...
      icon: (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M8 7h12.5M8 7v8.5A2.5 2.5 0 015.5 18v0A2.5 2.5 0 013 15.5V7a2 2 0 012-2h3m0 2v11m11-9h-3m3 0v4.5A2.5 2.5 0 0116.5 18v0A2.5 2.5 0 0114 15.5M16.5 18a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM5.5 18a2.5 2.5 0 100-5 2.5 2.5 0 000 5z"
          />
        </svg>
      ),
    },
          ...
          <div className="flex-1">
            <h2 className="text-gray-900 text-[18px] sm:text-xl md:text-2xl font-[600] tracking-tight leading-snug md:leading-tight">
              ...
              <span className="text-[#16a34a] inline-flex items-center gap-1.5 mt-0.5 md:mt-0">
                Greener Planet
                <svg
                  className="w-5 h-5 md:w-6 md:h-6 text-[#16a34a] drop-shadow-sm shrink-0"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
