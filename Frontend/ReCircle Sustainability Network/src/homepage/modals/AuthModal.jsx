...
const AuthModal = ({ isOpen, onClose, onLoginSuccess }) => {
  ...
  const getInputClass = (fieldName) =>
    `rc-input w-full bg-gray-50 border rounded-lg px-3 py-2 text-[13px] font-[600] text-gray-900 focus:bg-white outline-none transition-all ${
      errors[fieldName]
          ...
          <div className="flex-shrink-0 bg-white border-b border-gray-200 px-4 pt-4 pb-3 sm:px-6 sm:pt-5">
              ...
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="min-w-0 leading-tight">
                  <h1 className="rc-display font-[600] tracking-tight leading-none whitespace-nowrap">
                    <span className="text-[#111827] text-[24px] sm:text-[25px]">
                      Re
                    </span>
                    <span className="text-[#166534] text-[24px] sm:text-[25px]">
                      Circle
                    </span>
                  </h1>
            ...
            {errors.general && (
              <div className="mt-3 p-2.5 bg-red-50 border border-red-200 rounded-lg text-center">
                <p className="text-red-600 text-[11.5px] font-[700]">
                  {errors.general}
                </p>
              </div>
            )}
          ...
          >
            <div className="rc-scroll flex-1 overflow-y-auto px-4 py-4 sm:px-6 sm:py-2 flex flex-col gap-3">
              {!isLogin && (
                <>
                  <div className="mb-1">
                    <p className="text-[10px] font-[800] text-gray-700 uppercase tracking-[0.1em] mb-2">
                      I'm joining as
                    </p>
                    <div className="grid grid-cols-2 gap-2">
                      {[
                        ...
                        >
                          <div
                            className={`w-8 h-8 rounded-lg flex items-center justify-center text-sm ${selectedRole === id ? "bg-green-100" : "bg-gray-100"}`}
                          >
                            {emoji}
                          </div>
                          <div className="min-w-0">
                            <div
                              className={`text-[12px] font-[800] ${selectedRole === id ? "text-[#166534]" : "text-gray-800"}`}
                            >
                              {label}
                            </div>
                            <div className="text-[9px] font-[600] text-gray-400">
                              {sub}
                            </div>
                          </div>
                        </button>
              ...
              <div
                className={`grid gap-2.5 ${!isLogin ? "grid-cols-1 sm:grid-cols-2" : "grid-cols-1"}`}
              >
                ...
                <FieldGroup
                  ...
                  labelRight={
                    isLogin && (
                      <a
                        href="#"
                        className="text-[11px] font-[800] text-[#166534] hover:underline"
                      >
                        Forgot?
                      </a>
                    )
                ...
                <div className="pt-1">
                  <label className="flex items-start gap-2 cursor-pointer">
                    ...
                    <span className="text-[10px] font-[600] text-gray-500 leading-snug">
                      I agree to ReCircle's{" "}
                      <a href="#" className="text-[#166534] font-[700]">
                        Terms
                      </a>{" "}
                      &{" "}
                      <a href="#" className="text-[#166534] font-[700]">
...
const FieldGroup = ({ label, labelRight, children, className = "", error }) => (
  <div className={`flex flex-col gap-1.5 ${className}`}>
    <div className="flex items-center justify-between">
      <label className="text-[11.5px] font-[600] text-gray-600 uppercase tracking-wide">
        {label}
      </label>
      {labelRight}
    </div>
    {children}
    {error && (
      <p className="text-red-500 text-[10px] font-bold mt-[-3px] px-1">
        {error}
      </p>
    )}
  </div>
